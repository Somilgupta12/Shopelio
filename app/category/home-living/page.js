...
const HomeLivingPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const homeLivingProducts = allProducts.filter(product => product.category === 'Home & Living');
        setProducts(homeLivingProducts);
        setFilteredProducts(homeLivingProducts);
      } catch (error) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Home & Living</h1>
